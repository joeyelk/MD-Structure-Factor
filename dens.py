...
def load_radii(filename):
    """
    returns a dict. keys are atom symbols or types, and value is a list containing electron number and gaussian width
    ...
    for line in lines:
        ...
        # divided by 100 to convert pm to angstroms
...
def get_dplot(dmag):
    """ convert array to full 3d plottable array """
    ...
    dplot[dplot.shape[0]/2, dplot.shape[1]/2, dplot.shape[2]/2] = 1.0/3.0*(dplot[dplot.shape[0]/2 + 1, dplot.shape[1]/2,
                                dplot.shape[2]/2] + dplot[dplot.shape[0]/2, dplot.shape[1]/2 + 1, dplot.shape[2]/2] +
                                                        dplot[dplot.shape[0]/2, dplot.shape[1]/2, dplot.shape[2]/2 + 1])
